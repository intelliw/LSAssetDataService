...
namespace LSAssetDataService {
    ...
    internal partial class LSAssetWorkflowData : LSAssetData {

        #region VARIABLES & CONSTANTS ---------------------------------------------------------------- 

        private const string EVENTLogSourceName = "Asset Workflow Data";                // source must same as in 'LSAssetDataService-EventLog.ps1'
        ...
        public LSAssetWorkflowData(string[] args) : base(args) {
            
            // create the filewriter and data reader for this service
            AssetDataFileWriter = new LsawdFileWriter(Parameters.TargetFolderPath, Log);
            AssetDataReader = new LsawdDataReader(Parameters.DatabaseServer, Parameters.AssetDatabaseName, Parameters.LSDatabaseName, Log);
        }
        #endregion
